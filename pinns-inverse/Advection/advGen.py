...
def set_function(x, t, beta):
    return np.sin(2.0 * np.pi * (x - beta * t))
...
def main():
    ...
    while t < fin_time:
        ...
        u = set_function(xc, t, beta)  # Update u based on advection
    ...
    if if_show:
        ...
        try:
            ani.save(os.path.join(save_path, "advection_clean.gif"), writer=gif_writer)
